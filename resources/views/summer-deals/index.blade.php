        ...
        @forelse($giftPacks as $gift)
            <div class="col-6 col-md-4 col-lg-3">
                <div class="card shadow-sm h-100 border-0 rounded-3">
                    ...
                    {{-- Gift Image (Admin uploaded) or fallback product image --}}
...
@endif
    ...
    View Details
                            ...
                            {{-- Add to Cart (agar variation available ho) --}}
                            @if($gift->product->smallestVariation)
                                <form action="{{ route('cart.add', $gift->product->slug) }}" method="POST">
                                    ...
                                    <input type="hidden" name="volume" value="{{ $gift->product->smallestVariation->type }}">
